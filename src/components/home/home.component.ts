...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [CommonModule, HeaderComponent, AboutComponent, ServiceComponent, FooterComponent, WhyComponent, TeamComponent, RouterOutlet, FormsModule, HttpClientModule, ReactiveFormsModule],
